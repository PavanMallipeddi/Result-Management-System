...
$dob=$_POST['dob']; 
$status=$_POST['status'];
$sql="update tblstudents set StudentName=:studentname,RollId=:rol   lid,StudentEmail=:studentemail,Gender=:gender,DOB=:dob,Status=:status where StudentId=:stid ";
...
<html lang="en">
    <head>
        ...
        <title>SRP Admin| Edit Student < </title>
