...
$sql="update  tblclasses set ClassName=:classname,ClassNameNumeric=:classnamenumeric, ";
...
<html lang="en">
    <head>
        ...
        <title>SRP Admin Update Class</title>
...
{   ?>
                                                    ...
                                                    <div class="form-group has-success">
                                                       ...
                                                       <div class="form-group has-success">
                                                        ...
                                                        <div class="">
                                                            <input type="number" name="classnamenumeric" value="<?php echo htmlentities($result->ClassNameNumeric);?>" required="required"min="1" max="8" class="form-control" id="success">
