...
<html lang="en">
    <head>
        ...
        <title>SRP Admin| Student Admission< </title>
...
<div class="form-group">
<label for="default" class="col-sm-2 control-label">PRN no</label>
<div class="col-sm-10">
<input type="text" name="rollid" class="form-control" id="rollid" maxlength="16" required="required" autocomplete="off">
</div>
</div>
...
<input type="radio" name="gender" value="Male" required="required" checked="">Male <input type="radio" name="gender" value="Female" required="required">Female <input type="radio" name="gender" value="Other" required="required">Other
                                                    ...
                                                    <div class="form-group">
                                                        <label for="default" class="col-sm-2 control-label">Class/Sem</label>
                                                        <div class="col-sm-10">
