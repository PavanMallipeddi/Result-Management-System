                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-12">
                                    <h2 class="title" align="center">Student Result Processing</h2>
                                </div>
                            </div>
                            <!-- /.row -->
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <img  src='images/CollegeLogo.jpg' height="150" width="120" alt="College logo"> 
                                                    <h3 id="result" align="center" >Shri Mahadev Baburao Chaughule Mahavidyalaya</h3>
...
<p><b>Student PRN no :</b> <?php echo htmlentities($row->RollId);?>
